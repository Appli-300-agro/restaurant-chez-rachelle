# Restaurant Chez Rachelle - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Restaurant Chez Rachelle**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@restaurantchezrachelle.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@restaurantchezrachelle.cm` | `user123` | |
...
*   **Contact :** contact@restaurantchezrachelle.cm